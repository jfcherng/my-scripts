...
wget -c https://www.gnupg.org/ftp/gcrypt/libgpg-error/libgpg-error-1.47.tar.gz
wget -c https://www.gnupg.org/ftp/gcrypt/libgcrypt/libgcrypt-1.10.3.tar.gz
wget -c https://www.gnupg.org/ftp/gcrypt/libassuan/libassuan-2.5.6.tar.bz2
wget -c https://www.gnupg.org/ftp/gcrypt/libksba/libksba-1.6.5.tar.bz2
...
wget -c https://www.gnupg.org/ftp/gcrypt/gnupg/gnupg-2.4.3.tar.bz2

tar -xzf libgpg-error-1.47.tar.gz
tar -xzf libgcrypt-1.10.3.tar.gz
tar -xjf libassuan-2.5.6.tar.bz2
tar -xjf libksba-1.6.5.tar.bz2
